...
\mathrm{d}y}
\onslide<3->{\intertext{Compare with Lotka}1 &= \int_{a=0}^\infty F_al_a
\mathrm{d}a}
\end{align}
...
\vskip-.5cm
\begin{figure}
\includegraphics<1>[width=3in,height=3in]{FiguresStatic/rSingleSex1}
\includegraphics<2>[width=3in,height=3in]{FiguresStatic/rSingleSex2}
\end{figure}
\end{frame}
