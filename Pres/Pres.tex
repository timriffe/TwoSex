...
\begin{frame}
  ...
  \onslide<4-> Formal demographers and others have been working on this for a
  long time -- from Karmel (1947) to Garibaldi and Sobottka (2013)\\
  \vspace{2em}
  \onslide<5-> *We examine the intrinsic growth rate, $r$
\end{frame}
...
\begin{frame}
  \frametitle{The sex-gap in $r$ is a compound}
  \vspace{-2em}
\begin{figure}
\centering
...
\begin{frame}
  \frametitle{The sex-gap in thanatological $r$ is a compound}
  \vspace{-2em}
\begin{figure}
\centering
\caption*{Components to sex-gap in $r$; US, 1969-2009}
