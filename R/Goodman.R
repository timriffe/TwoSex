...
#save(rUS, file = "Data/results/agerSRB/rGoodmanUS.Rdata")
#save(rES, file = "Data/results/agerSRB/rGoodmanES.Rdata")

# plot it
pdf("latex/Figures/Goodmanager.pdf", height = 5, width = 5)
