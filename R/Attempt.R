...
plot(1984:2009, diffsUSaPred15[,2], type = 'l', col = "blue", ylim = c(-.1,.1))
lines(1984:2009, diffsUSexPred15[,2], col = "red")
lines(1989:2009, diffsESaPred15[,2], col = "blue", lty = 15)
lines(1989:2009, diffsESexPred15[,2], col = "red", lty = 15)
abline(h=0)
