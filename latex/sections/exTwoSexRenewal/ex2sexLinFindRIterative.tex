...
\end{equation}
  ...
  \end{equation}
  Use the improved $r$ to reestimate the sex ratio at birth, using
  ...
  S^1 = \frac{ \int _{y'=0}^\infty \int _{a'=y'}^\infty e^{-ra'}
                      d_{a'}^F f_{y'}^{F-M} \dd a' \dd y' + \int _{y=0}^\infty \int _{a=y}^\infty e^{-ra}
                      d_{a}^F f_{y}^{M-M} \dd a \dd y}{\int _{y'=0}^\infty \int _{a'=y'}^\infty e^{-ra'}
                      d_{a'}^F f_{y'}^{F-F} \dd a' \dd y' + \int _{y=0}^\infty
                      \int _{a=y}^\infty e^{-ra} d_{a}^F f_{y}^{M-F} \dd a \dd
                      y}
  \end{equation}
