...
The expected cross-classified age distribution $\textbf{E}(B(x,y))$ is defined
as:
...
\end{equation}
,where $f_1$ is $B_{xy}$ and $f_2$ is $\textbf{E}(B_{xy})$, both scaled to sum
...
The bivariate age-distributions for both countries were rather far from being
...
partner. Since the shinking of the departure from randomness in Spain 
...
since which time the trend has gradually wavered upward. In recent years, the
departure from randomness has been considerably higher than in Spain.
...
1990s, which has held constant. The greatest drivers of the larger downward trend have been declines in excess hypergamy: those more imaginably a result of
...
which is more or less a product of sex-differences in the distribution, and
which owes in part to evolved differences in the reproductive span-- obtaining a
...
interest to the designer of two-sex reproductive models that incorporate
 assumptions about age-combinations. Such models have been known to make all
