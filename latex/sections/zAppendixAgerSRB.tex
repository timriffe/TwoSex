...
\begin{table}
  ...
  \centering
    ...
    US, 1969-2009.}
    \label{tab:USageALL}
        \scriptsize{\input{xtables/USageALL.tex}}
  \end{adjustwidth}
\end{table}
...
\begin{table}
  ...
  \centering
    ...
    \label{tab:USageSRBALL}
        \footnotesize{\input{xtables/USageSRBALL.tex}}
  \end{adjustwidth}
\end{table}
...
\begin{table}
  ...
  \centering
    ...
    Spain, 1975-2009.}
    \label{tab:ESageALL}
        \scriptsize{\input{xtables/ESageALL.tex}}
  \end{adjustwidth}
\end{table}
...
\begin{table}
  ...
  \centering
    ...
    \label{tab:ESageSRBALL}
        \footnotesize{\input{xtables/ESageSRBALL.tex}}
  \end{adjustwidth}
\end{table}
