...
the sex-discrepancy entailed by $e_y$-classified data is on the order of 5 times 
...
hence using $e_y$- vs age-classified data US, 1969-2009}
...
\makebox[0pt][c]{\parbox{1.1\textwidth}{%
    ...
    \centering
        ...
        \input{xtables/exDivergenceMeanTableUS.tex}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.55\hsize}
    \centering
        \caption*{Mean Absolute Relative Discrepancy}
        \input{xtables/exDivergenceMeanAbsTableUS.tex}
    \end{minipage}
}}
\end{table}
...
\begin{table}
\caption{Relative discrepancy between single-sex projected births $n$ years
hence using $e_y$- vs age-classified data, Spain 1975-2009}
...
\makebox[0pt][c]{\parbox{1.1\textwidth}{%
    ...
    \centering
        \caption*{Mean Relative Discrepancy}
        \input{xtables/exDivergenceMeanTableES.tex}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.55\hsize}
    \centering
        \caption*{Mean Absolute Relative Discrepancy}
        \input{xtables/exDivergenceMeanAbsTableES.tex}
    \end{minipage}
}}
\end{table}
