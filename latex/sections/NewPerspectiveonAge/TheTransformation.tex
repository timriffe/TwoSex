...
Formula~\eqref{eq:vaupelredist} can thus be used to weight age-classified data as well, 
and when then integrated over age is equal to Equation~\eqref{eq:dxredist}.
