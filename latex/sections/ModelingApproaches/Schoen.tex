...
start (likely based on the initial data), or by modifying the iterative procedure
...
varies from the initial sex ratio at birth only to the extent that there is
...
Specifically, an increase in males of age $a$ will increase observed fertility
rates for all ages of females that share rates with males of age $a$. Further, females with
...
with respect to the sexes, although one could easily include weights.
