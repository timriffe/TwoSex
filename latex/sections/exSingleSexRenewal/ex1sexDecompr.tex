...
$e_x$-structured populations, we have given some measures of its
...
intrinsic growth rate, $r$ between males and females, as well as other measures
of magnitude that were also applied Section~\ref{sec:Divergence}. We
will now repeat the decomposition exercise that was the topic of Section~\ref{sec:Decompr},
 but for the male and female intrinsic growth rates
derived from the $e_x$-structured model. Specifically, we partition the gap,
$r^m-r^f$ into three components: the difference due to fertility, mortality and the sex
...
one would expect. However, in the case of $e_x$-structured populations,
...
fertilty effects were in some years greater in the $e_x$-structured model--
especially years 1980 onward in Spain. Both the age-structured model and the
$e_x$-structured model show rather stable forces contributing to the gap in
