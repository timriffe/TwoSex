...
\makebox[0pt][c]{\parbox{1.1\textwidth}{%
    ...
    \centering
        ...
        \input{/home/triffe/git/DISS/latex/xtables/exDivergenceMeanTableUS.tex}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.55\hsize}
    \centering
        \caption*{Mean Absolute Relative Discrepancy}
        \input{/home/triffe/git/DISS/latex/xtables/exDivergenceMeanAbsTableUS.tex}
    \end{minipage}
}}
\end{table}
...
\makebox[0pt][c]{\parbox{1.1\textwidth}{%
    ...
    \centering
        \caption*{Mean Relative Discrepancy}
        \input{/home/triffe/git/DISS/latex/xtables/exDivergenceMeanTableES.tex}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.55\hsize}
    \centering
        \caption*{Mean Absolute Relative Discrepancy}
        \input{/home/triffe/git/DISS/latex/xtables/exDivergenceMeanAbsTableES.tex}
    \end{minipage}
}}
\end{table}
