...
and gradient functions may prove even more efficient, but the author has not
tried this, as the present routine is more than efficient enough for practical
purposes.}. When applied to the data from the US and Spain, we see the trends
