...
\end{equation}
, where $n$ is treated as $a'$ in \ref{eq:dxredist}.
...
cannot be directly compared with a typical age-specific rate, since the time 
scales are different, but we 
...
\begin{equation}
\label{eq:exTFR}
e_x\mathrm{-TFR} = \int _{a'=0}^\infty F_a' \dd a'
\end{equation}
